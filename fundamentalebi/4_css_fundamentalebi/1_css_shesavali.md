...
- [ID სელქტორი](#id--id-selector)
- [Properties](#properties)
- [ფონტის დამატება ინტერნეტიდან](#---adding-font-from-internet)
- [როგორ დავამატოთ HTML-ში CSS](#--html--css-add-css-to-html)
- [დავალება](#-homework)
...
CSS-ში არის properties, ე.წ. სტილები, რომლებსაც სულ გამოვიყენებთ. ჩვენ ამჟამად ვისწავლით რამდენიმეს, რომელიც დასაწყისისთვის გამოგვადგება.
